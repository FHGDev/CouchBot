...
namespace MTD.CouchBot.Domain
{
    public static class Constants
    {
        ...
        //public static readonly int TwitchServerInterval = Settings.IntervalSettings.TwitchServerInterval * 1000;
        ...
        public static readonly Color Yellow = new Color(243, 243, 21);
