...
namespace MTD.CouchBot.Modules
{
    ...
    public class Config : ModuleBase
    {
        ...
        public Config(DiscordService discordService, IOptions<BotSettings> botSettings, FileService fileService)
        {
        ...
        public async Task List()
        {
            ...
            if (server != null)
            {
                ...
                string info = "```Markdown\r\n" +
                              ...
                              "- Discover Twitch: " + (string.IsNullOrEmpty(server.DiscoverTwitch) ? "None" : StringUtilities.FirstLetterToUpper(server.DiscoverTwitch)) + "\r\n" +
                              "- Discover Twitch Role: " + (server.DiscoverTwitchRole == 0 ? "None" : Context.Guild.GetRole(server.DiscoverTwitchRole).Name) + "\r\n" +
                              "```\r\n";
